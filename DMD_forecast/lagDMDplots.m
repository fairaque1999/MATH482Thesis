...
X_pred300 = DMDpredict(X_sel300, 35, 0.05, 50);
X_mat300 = [X_sel300(1:80, :) real(X_pred300(1:80, :))];
...
% saveas(wind_fig300, "wind_fig300_lagDMD.png")
% saveas(conc_fig300, "conc_fig300_lagDMD.png")
...
title("Lagrangian DMD Prediction of Lorenz-96 Wind at Site 15")
xlabel("Timesteps")
...
title("Lagrangian DMD Prediction of Tracer Concentration at Site 33")
xlabel("Timesteps")
ylabel("Tracer Concentration")
legend("DMD Forecast", "Model Data")


% saveas(windsite_fig300, "windsite_fig300_lagDMD.png")
% saveas(concsite_fig300, "concsite_fig300_lagDMD.png")
...
% Creating the prediction matrix
X_pred500 = DMDpredict(X_sel500, 35, 0.05, 50);
X_mat500 = [X_sel500(1:80, :) real(X_pred500(1:80, :))];
...
% saveas(wind_fig500, "wind_fig500_lagDMD.png")
% saveas(conc_fig500, "conc_fig500_lagDMD.png")
...
% saveas(windsite_fig500, "windsite_fig500_lagDMD.png")
% saveas(concsite_fig500, "concsite_fig500_lagDMD.png")
...
% Creating the prediction matrix
X_pred1000 = DMDpredict(X_sel1000, 35, 0.05, 50);
X_mat1000 = [X_sel1000(1:80, :) real(X_pred1000(1:80, :))];
...
% saveas(wind_fig1000, "wind_fig1000_lagDMD.png")
% saveas(conc_fig1000, "conc_fig1000_lagDMD.png")
...
% saveas(windsite_fig1000, "windsite_fig1000_lagDMD.png")
% saveas(concsite_fig1000, "concsite_fig1000_lagDMD.png")
