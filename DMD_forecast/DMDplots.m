...
X_pred300 = DMDpredict(X_sel300, 45, 0.05, 50);
...
% saveas(wind_fig300, "wind_fig300_DMD.png")
% saveas(conc_fig300, "conc_fig300_DMD.png")
...
title("DMD Prediction of Tracer Concentration at Site 33")
xlabel("Timesteps")
ylabel("Tracer Concentration")
legend("DMD Forecast", "Model Data")


% saveas(windsite_fig300, "windsite_fig300_DMD.png")
% saveas(concsite_fig300, "concsite_fig300_DMD.png")
...
% Creating the prediction matrix
X_pred500 = DMDpredict(X_sel500, 45, 0.05, 50);
...
% saveas(wind_fig500, "wind_fig500_DMD.png")
% saveas(conc_fig500, "conc_fig500_DMD.png")
...
% saveas(windsite_fig500, "windsite_fig500_DMD.png")
% saveas(concsite_fig500, "concsite_fig500_DMD.png")
...
% Creating the prediction matrix
X_pred1000 = DMDpredict(X_sel1000, 45, 0.05, 50);
...
% saveas(wind_fig1000, "wind_fig1000_DMD.png")
% saveas(conc_fig1000, "conc_fig1000_DMD.png")
...
% saveas(windsite_fig1000, "windsite_fig1000_DMD.png")
% saveas(concsite_fig1000, "concsite_fig1000_DMD.png")
